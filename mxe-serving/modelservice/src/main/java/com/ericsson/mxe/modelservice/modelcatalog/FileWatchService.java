...
public class FileWatchService {
    ...
    private static final String SERVICE_CONTAINER_NAME = "eric-mxe-model-service";
    private static final String LOG_CONTROL_FILE = "/app/config/logcontrol/logcontrol.json";
    private static final String SERVICE_LOGGER_NAME = "com.ericsson.mxe.modelservice";
