...
{{- define "eric-mxe-seldon-service-account.aggregatedMerge" -}}
  {{- $merged := dict -}}
  {{- $context := .context -}}
  {{- $location := .location -}}
...
*/ -}}
{{- define "eric-mxe-seldon-service-account.mergeAnnotations" -}}
  {{- include "eric-mxe-seldon-service-account.aggregatedMerge" (dict "context" "annotations" "location" .location "sources" .sources) }}
{{- end -}}
{{- define "eric-mxe-seldon-service-account.mergeLabels" -}}
  {{- include "eric-mxe-seldon-service-account.aggregatedMerge" (dict "context" "labels" "location" .location "sources" .sources) }}
{{- end -}}
