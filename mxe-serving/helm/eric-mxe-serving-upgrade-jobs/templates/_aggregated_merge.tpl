...
{{- define "eric-mxe-serving-upgrade-jobs.aggregatedMerge" -}}
  {{- $merged := dict -}}
  {{- $context := .context -}}
  {{- $location := .location -}}
...
*/ -}}
{{- define "eric-mxe-serving-upgrade-jobs.mergeAnnotations" -}}
  {{- include "eric-mxe-serving-upgrade-jobs.aggregatedMerge" (dict "context" "annotations" "location" .location "sources" .sources) }}
{{- end -}}
{{- define "eric-mxe-serving-upgrade-jobs.mergeLabels" -}}
  {{- include "eric-mxe-serving-upgrade-jobs.aggregatedMerge" (dict "context" "labels" "location" .location "sources" .sources) }}
{{- end -}}
