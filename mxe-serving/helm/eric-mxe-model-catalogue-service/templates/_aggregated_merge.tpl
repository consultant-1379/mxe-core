...
{{- define "eric-mxe-model-catalogue-service.aggregatedMerge" -}}
  {{- $merged := dict -}}
  {{- $context := .context -}}
  {{- $location := .location -}}
...
*/ -}}
{{- define "eric-mxe-model-catalogue-service.mergeAnnotations" -}}
  {{- include "eric-mxe-model-catalogue-service.aggregatedMerge" (dict "context" "annotations" "location" .location "sources" .sources) }}
{{- end -}}
{{- define "eric-mxe-model-catalogue-service.mergeLabels" -}}
  {{- include "eric-mxe-model-catalogue-service.aggregatedMerge" (dict "context" "labels" "location" .location "sources" .sources) }}
{{- end -}}
