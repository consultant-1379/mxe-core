...
{{- define "eric-mxe-serving-pre-upgrade-job.aggregatedMerge" -}}
  {{- $merged := dict -}}
  {{- $context := .context -}}
  {{- $location := .location -}}
...
*/ -}}
{{- define "eric-mxe-serving-pre-upgrade-job.mergeAnnotations" -}}
  {{- include "eric-mxe-serving-pre-upgrade-job.aggregatedMerge" (dict "context" "annotations" "location" .location "sources" .sources) }}
{{- end -}}
{{- define "eric-mxe-serving-pre-upgrade-job.mergeLabels" -}}
  {{- include "eric-mxe-serving-pre-upgrade-job.aggregatedMerge" (dict "context" "labels" "location" .location "sources" .sources) }}
{{- end -}}
