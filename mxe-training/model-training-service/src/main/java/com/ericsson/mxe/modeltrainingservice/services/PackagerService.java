...
import com.ericsson.mxe.modeltrainingservice.config.properties.AuthorServiceProperties;
import com.ericsson.mxe.modeltrainingservice.config.properties.DockerProperties;
import com.ericsson.mxe.modeltrainingservice.config.properties.InstallerDockerRegistryProperties;
import com.ericsson.mxe.modeltrainingservice.config.properties.ModelPackagerProperties;
...
import com.ericsson.mxe.modeltrainingservice.dto.request.CreateRequest;
import com.ericsson.mxe.modeltrainingservice.dto.response.ModelTrainingServiceResponse;
import com.ericsson.mxe.modeltrainingservice.services.minio.MinioRepositoryUploader;
...
public class PackagerService {
    ...
    private static String initCaUpdateCmd;
    ...
    public PackagerService(final KubernetesService kubernetesService,
            ...
            final AccessControl accessControl, final ServiceMeshProperties serviceMeshProperties) {
    ...
    public <REQUEST extends CreateRequest, STATUS extends Status> ModelTrainingServiceResponse handleDataAndJob(
        ...
        return new ModelTrainingServiceResponse("Packaging has been started");
    }
    ...
    private void startJob(final String packageName, final String dummyEntityName,
        ...
        if (StringUtils.isNotEmpty(this.modelCatalogueServiceProperties.getDockerfile())) {
            ...
            final V1VolumeMount dockerfileConfigMapVolumeMount = new V1VolumeMount();
            dockerfileConfigMapVolumeMount.setName(DOCKERFILE_NAME);
            dockerfileConfigMapVolumeMount.setMountPath("/mnt/dockerfile");
            dockerfileConfigMapVolumeMount.setReadOnly(true);
            container.addVolumeMountsItem(dockerfileConfigMapVolumeMount);
        }
