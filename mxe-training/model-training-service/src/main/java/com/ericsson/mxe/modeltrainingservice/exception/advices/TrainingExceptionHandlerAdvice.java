package com.ericsson.mxe.modeltrainingservice.exception.advices;
...
public class TrainingExceptionHandlerAdvice {
    private static final Logger LOGGER = LoggerFactory.getLogger(TrainingExceptionHandlerAdvice.class);
