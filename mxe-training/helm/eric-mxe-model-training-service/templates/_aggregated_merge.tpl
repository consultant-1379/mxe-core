...
{{- define "eric-mxe-model-training-service.aggregatedMerge" -}}
  {{- $merged := dict -}}
  {{- $context := .context -}}
  {{- $location := .location -}}
...
*/ -}}
{{- define "eric-mxe-model-training-service.mergeAnnotations" -}}
  {{- include "eric-mxe-model-training-service.aggregatedMerge" (dict "context" "annotations" "location" .location "sources" .sources) }}
{{- end -}}
{{- define "eric-mxe-model-training-service.mergeLabels" -}}
  {{- include "eric-mxe-model-training-service.aggregatedMerge" (dict "context" "labels" "location" .location "sources" .sources) }}
{{- end -}}
