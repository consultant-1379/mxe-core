...
{{- define "eric-mxe-training-pre-upgrade-job.aggregatedMerge" -}}
  {{- $merged := dict -}}
  {{- $context := .context -}}
  {{- $location := .location -}}
...
*/ -}}
{{- define "eric-mxe-training-pre-upgrade-job.mergeAnnotations" -}}
  {{- include "eric-mxe-training-pre-upgrade-job.aggregatedMerge" (dict "context" "annotations" "location" .location "sources" .sources) }}
{{- end -}}
{{- define "eric-mxe-training-pre-upgrade-job.mergeLabels" -}}
  {{- include "eric-mxe-training-pre-upgrade-job.aggregatedMerge" (dict "context" "labels" "location" .location "sources" .sources) }}
{{- end -}}