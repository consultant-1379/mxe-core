// @apiVersion 0.1
// @name io.ksonnet.pkg.seldon-mab-v1-mxe
// @description An e-greeey multi-armed bandit solver between two models for the v1 CRD (Seldon 0.2.X), with increased initialDelaySeconds
// @shortDescription An e-greeey multi-armed bandit for two models (MXE)
