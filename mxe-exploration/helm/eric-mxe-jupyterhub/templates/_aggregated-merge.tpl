...
*/ -}}
{{- define "eric-mxe-jupyterhub.aggregatedMerge" -}}
  {{- $merged := dict -}}
  {{- $context := .context -}}
  {{- $location := .location -}}
...
*/ -}}
{{- define "eric-mxe-jupyterhub.mergeAnnotations" -}}
  {{- include "eric-mxe-jupyterhub.aggregatedMerge" (dict "context" "annotations" "location" .location "sources" .sources) }}
{{- end -}}
{{- define "eric-mxe-jupyterhub.mergeLabels" -}}
  {{- include "eric-mxe-jupyterhub.aggregatedMerge" (dict "context" "labels" "location" .location "sources" .sources) }}
{{- end -}}
