...
{{- define "eric-mxe-argo.aggregatedMerge" -}}
  {{- $merged := dict -}}
  {{- $context := .context -}}
  {{- $location := .location -}}
...
*/ -}}
{{- define "eric-mxe-argo.mergeAnnotations" -}}
  {{- include "eric-mxe-argo.aggregatedMerge" (dict "context" "annotations" "location" .location "sources" .sources) }}
{{- end -}}
{{- define "eric-mxe-argo.mergeLabels" -}}
  {{- include "eric-mxe-argo.aggregatedMerge" (dict "context" "labels" "location" .location "sources" .sources) }}
{{- end -}}