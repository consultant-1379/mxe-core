...
*/ -}}
{{- define "eric-mxe-spark.aggregatedMerge" -}}
  {{- $merged := dict -}}
  {{- $context := .context -}}
  {{- $location := .location -}}
...
*/ -}}
{{- define "eric-mxe-spark.mergeAnnotations" -}}
  {{- include "eric-mxe-spark.aggregatedMerge" (dict "context" "annotations" "location" .location "sources" .sources) }}
{{- end -}}
{{- define "eric-mxe-spark.mergeLabels" -}}
  {{- include "eric-mxe-spark.aggregatedMerge" (dict "context" "labels" "location" .location "sources" .sources) }}
{{- end -}}
