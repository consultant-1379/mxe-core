...
public class AutoWiredApplicationContextRemoteTestExecutionHostProfile {
    ...
    private static final Logger LOGGER =
            LoggerFactory.getLogger(AutoWiredApplicationContextRemoteTestExecutionHostProfile.class);
    ...
    public static void beforeClassSetup() {
        LOGGER.info("[testClass: {}, commandProfile: {}]",
                AutoWiredApplicationContextRemoteTestExecutionHostProfile.class.getSimpleName(),
    ...
    public void testContextShouldInitProperMxeCliDriverType() {
        ...
        assertThat(applicationContext.getBean(MxeCliDriver.class, testExecutionHost),
                instanceOf(RemoteMxeCliDriver.class));
    }
