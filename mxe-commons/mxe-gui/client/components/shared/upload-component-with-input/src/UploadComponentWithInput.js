 ...
 * @example
 * let component = new UploadComponentWithInput();
 *
 * Declaratively create component
 * @example
 * <e-upload-component-with-input></e-upload-component-with-input>
 *
...
import { preventDefaultEvent, loc, getEventPath } from 'utils/Utils';
...
import style from './uploadComponentWithInput.css';

/**
 * @property {Number} progress - Upload progress
 */
@definition('e-upload-component-with-input', {
  style,
  home: 'upload-component-with-input',
  props: {
...
export default class UploadComponentWithInput extends LitComponent {
  didConnect() {
  ...
  handleFileChange(event) {
    ...
    if (this.file && (this.file.name.includes('yml') || this.file.name.includes('yaml'))) {
        ...
        ${
          this.file && this.progress === 100
            ...
            : html`
                ...
                <span class="description">${loc('DRAG_AND_DROP_YML')}</span>
 ...
 */
UploadComponentWithInput.register();
