...
{{- define "eric-mxe-meshgw-ingress.aggregatedMerge" -}}
  {{- $merged := dict -}}
  {{- $context := .context -}}
  {{- $location := .location -}}
...
*/ -}}
{{- define "eric-mxe-meshgw-ingress.mergeAnnotations" -}}
  {{- include "eric-mxe-meshgw-ingress.aggregatedMerge" (dict "context" "annotations" "location" .location "sources" .sources) }}
{{- end -}}
{{- define "eric-mxe-meshgw-ingress.mergeLabels" -}}
  {{- include "eric-mxe-meshgw-ingress.aggregatedMerge" (dict "context" "labels" "location" .location "sources" .sources) }}
{{- end -}}