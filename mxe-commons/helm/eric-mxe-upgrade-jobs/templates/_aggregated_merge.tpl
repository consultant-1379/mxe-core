...
{{- define "eric-mxe-upgrade-jobs.aggregatedMerge" -}}
  {{- $merged := dict -}}
  {{- $context := .context -}}
  {{- $location := .location -}}
...
*/ -}}
{{- define "eric-mxe-upgrade-jobs.mergeAnnotations" -}}
  {{- include "eric-mxe-upgrade-jobs.aggregatedMerge" (dict "context" "annotations" "location" .location "sources" .sources) }}
{{- end -}}
{{- define "eric-mxe-upgrade-jobs.mergeLabels" -}}
  {{- include "eric-mxe-upgrade-jobs.aggregatedMerge" (dict "context" "labels" "location" .location "sources" .sources) }}
{{- end -}}
