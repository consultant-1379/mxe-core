...
{{- define "eric-mxe-prometheus.aggregatedMerge" -}}
  {{- $merged := dict -}}
  {{- $context := .context -}}
  {{- $location := .location -}}
...
*/ -}}
{{- define "eric-mxe-prometheus.mergeAnnotations" -}}
  {{- include "eric-mxe-prometheus.aggregatedMerge" (dict "context" "annotations" "location" .location "sources" .sources) }}
{{- end -}}
{{- define "eric-mxe-prometheus.mergeLabels" -}}
  {{- include "eric-mxe-prometheus.aggregatedMerge" (dict "context" "labels" "location" .location "sources" .sources) }}
{{- end -}}