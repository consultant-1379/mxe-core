...
{{- define "eric-mxe-gui.aggregatedMerge" -}}
  {{- $merged := dict -}}
  {{- $context := .context -}}
  {{- $location := .location -}}
...
*/ -}}
{{- define "eric-mxe-gui.mergeAnnotations" -}}
  {{- include "eric-mxe-gui.aggregatedMerge" (dict "context" "annotations" "location" .location "sources" .sources) }}
{{- end -}}
{{- define "eric-mxe-gui.mergeLabels" -}}
  {{- include "eric-mxe-gui.aggregatedMerge" (dict "context" "labels" "location" .location "sources" .sources) }}
{{- end -}}