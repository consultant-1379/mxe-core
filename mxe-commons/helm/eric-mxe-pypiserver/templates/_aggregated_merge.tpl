...
{{- define "eric-mxe-pypiserver.aggregatedMerge" -}}
  {{- $merged := dict -}}
  {{- $context := .context -}}
  {{- $location := .location -}}
...
*/ -}}
{{- define "eric-mxe-pypiserver.mergeAnnotations" -}}
  {{- include "eric-mxe-pypiserver.aggregatedMerge" (dict "context" "annotations" "location" .location "sources" .sources) }}
{{- end -}}
{{- define "eric-mxe-pypiserver.mergeLabels" -}}
  {{- include "eric-mxe-pypiserver.aggregatedMerge" (dict "context" "labels" "location" .location "sources" .sources) }}
{{- end -}}