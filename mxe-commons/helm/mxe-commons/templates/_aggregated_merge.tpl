...
{{- define "mxe-commons.aggregatedMerge" -}}
  {{- $merged := dict -}}
  {{- $context := .context -}}
  {{- $location := .location -}}
...
*/ -}}
{{- define "mxe-commons.mergeAnnotations" -}}
  {{- include "mxe-commons.aggregatedMerge" (dict "context" "annotations" "location" .location "sources" .sources) }}
{{- end -}}
{{- define "mxe-commons.mergeLabels" -}}
  {{- include "mxe-commons.aggregatedMerge" (dict "context" "labels" "location" .location "sources" .sources) }}
{{- end -}}