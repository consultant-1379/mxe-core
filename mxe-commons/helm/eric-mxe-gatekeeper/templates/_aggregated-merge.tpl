...
*/ -}}
{{- define "eric-mxe-gatekeeper.aggregatedMerge" -}}
  {{- $merged := dict -}}
  {{- $context := .context -}}
  {{- $location := .location -}}
...
*/ -}}
{{- define "eric-mxe-gatekeeper.mergeAnnotations" -}}
  {{- include "eric-mxe-gatekeeper.aggregatedMerge" (dict "context" "annotations" "location" .location "sources" .sources) }}
{{- end -}}
{{- define "eric-mxe-gatekeeper.mergeLabels" -}}
  {{- include "eric-mxe-gatekeeper.aggregatedMerge" (dict "context" "labels" "location" .location "sources" .sources) }}
{{- end -}}
