...
{{- define "eric-mxe-default-backend.aggregatedMerge" -}}
  {{- $merged := dict -}}
  {{- $context := .context -}}
  {{- $location := .location -}}
...
*/ -}}
{{- define "eric-mxe-default-backend.mergeAnnotations" -}}
  {{- include "eric-mxe-default-backend.aggregatedMerge" (dict "context" "annotations" "location" .location "sources" .sources) }}
{{- end -}}
{{- define "eric-mxe-default-backend.mergeLabels" -}}
  {{- include "eric-mxe-default-backend.aggregatedMerge" (dict "context" "labels" "location" .location "sources" .sources) }}
{{- end -}}