...
*/ -}}
{{- define "eric-mxe-ingress-controller.aggregatedMerge" -}}
  {{- $merged := dict -}}
  {{- $context := .context -}}
  {{- $location := .location -}}
...
*/ -}}
{{- define "eric-mxe-ingress-controller.mergeAnnotations" -}}
  {{- include "eric-mxe-ingress-controller.aggregatedMerge" (dict "context" "annotations" "location" .location "sources" .sources) }}
{{- end -}}
{{- define "eric-mxe-ingress-controller.mergeLabels" -}}
  {{- include "eric-mxe-ingress-controller.aggregatedMerge" (dict "context" "labels" "location" .location "sources" .sources) }}
{{- end -}}
