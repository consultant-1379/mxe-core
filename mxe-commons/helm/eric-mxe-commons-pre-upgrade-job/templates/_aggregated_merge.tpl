...
{{- define "eric-mxe-commons-pre-upgrade-job.aggregatedMerge" -}}
  {{- $merged := dict -}}
  {{- $context := .context -}}
  {{- $location := .location -}}
...
*/ -}}
{{- define "eric-mxe-commons-pre-upgrade-job.mergeAnnotations" -}}
  {{- include "eric-mxe-commons-pre-upgrade-job.aggregatedMerge" (dict "context" "annotations" "location" .location "sources" .sources) }}
{{- end -}}
{{- define "eric-mxe-commons-pre-upgrade-job.mergeLabels" -}}
  {{- include "eric-mxe-commons-pre-upgrade-job.aggregatedMerge" (dict "context" "labels" "location" .location "sources" .sources) }}
{{- end -}}