...
{{- define "eric-mxe-deployer-service.aggregatedMerge" -}}
  {{- $merged := dict -}}
  {{- $context := .context -}}
  {{- $location := .location -}}
...
*/ -}}
{{- define "eric-mxe-deployer-service.mergeAnnotations" -}}
  {{- include "eric-mxe-deployer-service.aggregatedMerge" (dict "context" "annotations" "location" .location "sources" .sources) }}
{{- end -}}
{{- define "eric-mxe-deployer-service.mergeLabels" -}}
  {{- include "eric-mxe-deployer-service.aggregatedMerge" (dict "context" "labels" "location" .location "sources" .sources) }}
{{- end -}}